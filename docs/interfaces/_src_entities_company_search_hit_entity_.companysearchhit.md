...
*Defined in [src/entities/company-search-hit.entity.ts:5](https://github.com/cosiall/linkedin-private-api/blob/e4e3ce2/src/entities/company-search-hit.entity.ts#L5)*
